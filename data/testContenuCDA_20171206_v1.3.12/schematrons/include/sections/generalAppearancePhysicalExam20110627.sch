...
<!--                  -=<<o#%@O[ generalAppearancePhysicalExam.sch ]O@%#o>>=-
    
    Teste la conformité de la section "General appearance" (1.3.6.1.4.1.19376.1.5.3.1.1.9.16)
...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="generalAppearancePhysicalExam-errors">
