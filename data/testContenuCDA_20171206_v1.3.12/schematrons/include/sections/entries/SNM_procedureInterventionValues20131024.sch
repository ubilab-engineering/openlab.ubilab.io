...
<!--                  -=<<o#%@O[ SNM_proceduresInterventionValues.sch ]O@%#o>>=-
...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="SNM_procedureInterventionValues-errors">
    ...
    <rule context='*[cda:templateId/@root="1.3.6.1.4.1.19376.1.5.3.1.1.13.2.11"]'> 
        ...
        <assert test='not(cda:entry/cda:procedure[cda:code/@code="F-84610"]) 
            ...
            Erreur [SNM_proceduresInterventionValues]: Les valeurs possibles pour cet éléments sont
