...
<!-- 
    AVC_typeTraitementRt-PA20131025.sch :
    Contenu :
    Paramètres d'appel : Néant 
    Historique :
        25/10/2013 : CRI : Création
-->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="AVC_typeTraitementRt-PA" is-a="dansJeuDeValeurs">
    <param name="path_jdv" value="$jdv_AVC_typeTraitementRt-PA"/>
