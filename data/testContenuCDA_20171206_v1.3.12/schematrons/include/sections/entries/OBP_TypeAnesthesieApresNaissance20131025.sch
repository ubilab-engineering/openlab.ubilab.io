...
-->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="OBP_TypeAnesthesieApresNaissance" is-a="dansJeuDeValeurs">
    ...
    <param name="xpath_elt" value="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section/cda:component/cda:section/cda:entry/cda:procedure[cda:code/@code='OBS_031']/cda:entryRelationship/cda:procedure/cda:code"/>
