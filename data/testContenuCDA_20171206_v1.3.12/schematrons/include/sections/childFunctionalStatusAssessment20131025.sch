...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="childFunctionalStatusAssessment-errors">
    ...
    <rule context='*[cda:templateId/@root="1.3.6.1.4.1.19376.1.7.3.1.1.13.3"]'> 
       ...
       <!--<assert test='.//cda:templateId[@root ="1.3.6.1.4.1.19376.1.7.3.1.1.13.5"] or .//cda:templateId[@root ="1.3.6.1.4.1.19376.1.7.3.1.1.13.4"]'>
            [childFunctionalStatusAssessment] La section 'Child Functional Status Assessment' ne contient pas de sous-section'Eating and sleeping Assessment' ou de sous-section 'Psychomotor Development'.        
        </assert>--> 
