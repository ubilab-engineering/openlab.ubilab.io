...
-->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="SUNV_ModeleEnTete">
    <p>Conformité de l'en-tête CDA au modèle AUNV</p>
    <rule context="cda:ClinicalDocument">
        <assert test="cda:templateId[@root='1.2.250.1.213.1.1.1.17']"> 
            [SUNV_ModeleEnTete] Le template parent "Sortie d'UNV (SUNV)" (1.2.250.1.213.1.1.1.17) doit être présent.
        </assert>
        
        <assert test="./cda:code[@code='34133-9' and @codeSystem='2.16.840.1.113883.6.1']"> 
            [SUNV_ModeleEnTete] L'élément code doit avoir @code ="34133-9" et @codeSystem = "2.16.840.1.113883.6.1"/>. 
        </assert>
    </rule>
</pattern>
