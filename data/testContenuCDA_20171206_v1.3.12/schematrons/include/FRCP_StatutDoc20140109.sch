...
-->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="FRCP_StatutDoc" is-a="dansJeuDeValeurs">
    <p>Conformité du statut du document</p>
    <param name="path_jdv" value="$jdv_FRCP_StatutDoc"/>
