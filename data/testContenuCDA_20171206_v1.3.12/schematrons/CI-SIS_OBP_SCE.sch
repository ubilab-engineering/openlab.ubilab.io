...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" defaultPhase="SCE-20131017"
    ...
    <title>Conformité d'un document CDAr2 au volet OBP - Suites de Couches Enfant (SCE) du CI-SIS</title>
    ...
    <include href="include/SCE_ModeleEnTete20131017.sch"/> 
    ...
    <include href="include/sections/OBP_proceduresInterventionEntries.sch"/>
    ...
    <include href="include/sections/entries/OBP_StaticSCEprocedures20131025.sch"/>
    ...
    <phase id="SCE-20131017">
        ...
        <active pattern="SCE_ModeleEnTete"/> 
        ...
        <active pattern="OBP_proceduresInterventionEntries-errors"/>
        ...
        <active pattern="OBP_LesionTraumatiqueObstetricale"/>
        <active pattern="OBP_routeOfAdministration"/>
        <active pattern="OBP_TypePortageAgentInfectieux"/>
        <active pattern="CSE_CertDiag"/>
        <active pattern="OBP_TypeInfectionNN"/>
        <active pattern="OBP_ModeSortie"/>
        <active pattern="OBP_TypeAllaitementNN"/>
        <active pattern="OBP_StaticSCEprocedures"/>
    ...
    <pattern id="variables">
        ...
        <let name="jdv_OBP_LesionTraumatiqueObstetricale" value="'../jeuxDeValeurs/CI-SIS_jdv_OBP_LesionTraumatiqueObstetricale.xml'"/>
        <let name="jdv_routeOfAdministration" value="'../jeuxDeValeurs/CI-SIS_jdv_routeOfAdministration.xml'"/>
        <let name="jdv_OBP_TypePortageAgentInfectieux" value="'../jeuxDeValeurs/CI-SIS_jdv_OBP_TypePortageAgentInfectieux.xml'"/>
        <let name="jdv_CSE_CertDiag" value="'../jeuxDeValeurs/CI-SIS_jdv_CSE_CertDiag.xml'"/>
        <let name="jdv_OBP_TypeInfectionNN" value="'../jeuxDeValeurs/CI-SIS_jdv_OBP_TypeInfectionNN.xml'"/>
        <let name="jdv_OBP_ModeSortie" value="'../jeuxDeValeurs/CI-SIS_jdv_OBP_ModeSortie.xml'"/>
        <let name="jdv_OBP_TypeAllaitementNN" value="'../jeuxDeValeurs/CI-SIS_jdv_OBP_TypeAllaitementNN.xml'"/>
        <let name="jdv_OBP_StaticSCEprocedures" value="'../jeuxDeValeurs/CI-SIS_jdv_OBP_StaticSCEprocedures.xml'"/>
