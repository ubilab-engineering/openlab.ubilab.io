...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="causeAccidentDom" is-a="dansJeuDeValeurs">
    ...
    -->
    <param name="xpath_elt" value="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section/cda:entry/cda:act/cda:entryRelationship/cda:observation[cda:templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.4.5' and cda:value/@code='MED-185']/cda:entryRelationship/cda:observation/cda:value"/>
