...
<!--                  -=<<o#%@O[ UFCV_ProtheseValvulaireOrg.sch ]O@%#o>>=-
...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="UFCV_ProtheseValvulaireOrg-errors">
    ...
    <rule context='*[(/cda:ClinicalDocument/cda:templateId[@root="1.2.250.1.213.1.1.1.2.1.5"]) 
        ...
        <assert test='cda:code[@code ="D0001-11"]'> 
            Erreur de Conformité CI-SIS: Le code de l'organizer 'Prothèse Valvulaire' doit être L0062
            pris dans le vocabulaire TA_PRC (1.2.250.1.213.1.1.4.2)</assert> 
        
        <assert test='cda:code[@codeSystem = "1.2.250.1.213.1.1.4.2"]'> 
            Erreur de Conformité CI-SIS: L'élément 'codeSystem' de l'organizer 'Prothèse Valvulaire'
        ...
        <assert test='.//cda:templateId[@root = "1.2.250.1.213.1.1.1.3.1"]'> 
            Erreur de Conformité CI-SIS : L'organizer 'Prothèse Valvulaire' doit au moins contenir une entrée 'Observation Dispositifs Médicaux'</assert> 
        ...
        <!-- Numéro de série -->
        <assert test='cda:component/cda:observation[cda:templateId/@root="1.2.250.1.213.1.1.1.3.1"]/cda:code/@code="L0031"'> 
            Erreur de Conformité CI-SIS: Le 'numéro de série' de l'implant est un élément obligatoire de l'organizer.
        </assert>
        <!-- Valve -->
        <assert test='cda:component/cda:observation[cda:templateId/@root="1.2.250.1.213.1.1.1.3.1"]/cda:code/@code="L0031"'> 
            Erreur de Conformité CI-SIS: Le 'valve' que la prothèse remplace est un élément obligatoire de l'organizer.
        </assert>
        <!-- Compposant -->
        <assert test='cda:component/cda:observation[cda:templateId/@root="1.2.250.1.213.1.1.1.3.1"]/cda:code/@code="L0032"'> 
            Erreur de Conformité CI-SIS: Le 'composant' de la prothèse est un élément obligatoire de l'organizer.
        </assert>
        <!-- Diamètre -->
        <assert test='cda:component/cda:observation[cda:templateId/@root="1.2.250.1.213.1.1.1.3.1"]/cda:code/@code="L0033"'> 
            Erreur de Conformité CI-SIS: Le 'diamètre' de la prothèse est un élément obligatoire de l'organizer.
        </assert>
        <!-- Gradient -->
        <assert test='cda:component/cda:observation[cda:templateId/@root="1.2.250.1.213.1.1.1.3.1"]/cda:code/@code="L0034"'> 
            Erreur de Conformité CI-SIS: Le 'gradient' mesuré est un élément obligatoire de l'organizer.
        </assert>
        <!-- Niveau d'anticoagulation souhaité -->
        <assert test='cda:component/cda:observation[cda:templateId/@root="1.2.250.1.213.1.1.1.3.1"]/cda:code/@code="L0035"'> 
            Erreur de Conformité CI-SIS: Le 'niveau d'anticoagulation souhaité' est un élément obligatoire de l'organizer.
        </assert>
