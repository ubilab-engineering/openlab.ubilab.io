...
<!-- 
    ...
    Historique :
    25/10/2013 : CRI :OBP_AnomalieConstitutionnelle20131025.sch
-->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="OBP_AnomalieConstitutionnelle" is-a="dansJeuDeValeurs">
