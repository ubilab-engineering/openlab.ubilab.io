...
<!--                  -=<<o#%@O[ SNM_problemEntryValue20131024.sch ]O@%#o>>=-
...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="SNM_problemEntryValue-errors">
    ...
    <rule context="*[cda:templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.3.6']">
        <assert
            ...
            [SNM_problemEntryValue]: Les valeurs possibles pour cet éléments sont
