...
<!--                  -=<<o#%@O[ CSEcodedSocialHistoryEnt.sch ]O@%#o>>=-
    ...
    21/07/17 : NMA : Suppression des asserts sur le type de garde
    23/08/17 : NMA : Correction des codes pour le statut professionnel
