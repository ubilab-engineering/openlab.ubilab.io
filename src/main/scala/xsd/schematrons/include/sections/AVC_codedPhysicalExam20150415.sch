...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="AVCcodedPhysicalExam-errors">
    ...
    <rule context='*[cda:templateId/@root="1.3.6.1.4.1.19376.1.5.3.1.1.9.15.1"]'> 
        ...
        <assert test='.//cda:templateId[@root ="1.3.6.1.4.1.19376.1.5.3.1.1.5.3.2"]'>
            Erreur de Conformité au volet AVC: La section 'Coded physical exam' ne contient pas de sous-section'Coded Vital Signs'.
        </assert>
        <!-- Examen Neurologique -->
        <assert test='.//cda:templateId[@root ="1.3.6.1.4.1.19376.1.5.3.1.1.9.35"]'>
            Erreur de Conformité au volet AVC: La section 'Coded physical exam' ne contient pas de sous-section'Examen Neurologique'.
        </assert>
        <!-- Examen cardiovasculaire -->
        <assert test='.//cda:templateId[@root ="1.3.6.1.4.1.19376.1.5.3.1.1.9.29"]'>
            Erreur de Conformité au volet AVC: La section 'Coded physical exam' ne contient pas de sous-section 'Examen cardiovasculaire'.
        </assert> 
        <!-- Examen Pulmonaire  -->
        <assert test='.//cda:templateId[@root ="1.3.6.1.4.1.19376.1.5.3.1.1.9.26"]'>
            Erreur de Conformité au volet AVC: La section 'Coded physical exam' ne contient pas de sous-section 'Examen Pulmonaire'.
        </assert> 
    </rule>
</pattern>