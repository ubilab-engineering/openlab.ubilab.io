...
<!--                  -=<<o#%@O[ OBP_proceduresInterventionEntries.sch ]O@%#o>>=-
...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="OBP_proceduresInterventionEntries-errors">
    ...
    <rule context='*[cda:templateId/@root="1.3.6.1.4.1.19376.1.5.3.1.1.13.2.11"]'> 
        <assert test='cda:entry/cda:procedure/cda:code[@code="JQQP003"]'>
            Erreur [OBP_proceduresInterventionEntries]: Une section "Procedures and Interventions" 
