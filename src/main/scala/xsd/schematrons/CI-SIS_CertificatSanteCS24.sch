...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" defaultPhase="CS24-20121008"
    ...
    xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" schemaVersion="CI-SIS_CertificatSanteCS24.sch">
    <title>Conformité d'un document CDAr2 au volet Certificat de santé de l'enfant (modèle CS24) du CI-SIS</title>
    ...
    <include href="include/CS24ModeleEnTete20120425.sch"/>
    ...
    <include href="include/sections/CS24codedPhysicalExam20110725.sch"/>
   ...
   <include href="include/sections/entries/CSEeyesEnt20110627.sch"/>
    ...
    <include href="include/sections/entries/CSEteethEnt20110627.sch"/>
    -->
    <!-- Modifiés -->
    ...
    <phase id="CS24-20121008">
        ...
        <active pattern="CS24ModeleEnTete"/>
        ...
        <active pattern="CS24codedPhysicalExam-errors"/>
        ...
        <active pattern="typeGardeEnfant"/>
        <active pattern="typeGardePleinTemps"/>
    ...
    <pattern id="variables">
        ...
        <let name="jdv_typeGardeEnfant" value="'../jeuxDeValeurs/CI-SIS_jdv_typeGardeEnfant.xml'"/> 
        <let name="jdv_typeGardePleinTemps" value="'../jeuxDeValeurs/CI-SIS_jdv_typeGardePleinTemps.xml'"/> 
