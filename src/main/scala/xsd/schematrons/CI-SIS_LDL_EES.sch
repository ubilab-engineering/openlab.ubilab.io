...
-->
<schema xmlns="http://purl.oclc.org/dsdl/schematron" defaultPhase="LDL-20161212"
...
<!--        <let name="jdv_LDL_ModeDeTransport" value="'../jeuxDeValeurs/CI-SIS_jdv_LDL_ModeDeTransport.xml'"/>  
        <let name="jdv_LDL_SeverityObservation" value="'../jeuxDeValeurs/CI-SIS_jdv_LDL_SeverityObservation.xml'"/>  
        <let name="jdv_LDL_SocialHistoryCodes" value="'../jeuxDeValeurs/CI-SIS_jdv_LDL_SocialHistoryCodes.xml'"/> --> 
